        ...
        <div className="container mx-auto xl:px-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="lg:mt-0">
              <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-6">Volunteer</h1>
              <p className="text-gray-600 text-xl">
                Our volunteers are an integral part of our team and helps us make a positive impact!
              </p>
            </div>
            <div className="lg:mb-0">
              <div className="block rounded-lg shadow-lg bg-white px-6 py-12 md:px-12">
                ...
                <form>
                  <p className="mb-6">
                  Please, if you are interested in volunteering, fill out the form below and we will contact you with more information.
                  </p>
