      ...
      <div className="bg-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl mt-12 pt-4 pb-16 sm:pb-24 lg:max-w-none lg:py-32">
            ...
            {/* <p>We offer tourism opportunities to people who wishes to explore and experience the historical foundation, sites and the lives of the people of Ghana</p> */}
            <h2 className=" text-gray-900 mt-1 text-center text-xl md:text-2xl">We offer tourism opportunities to people who wishes to explore and experience the historical foundation, sites and the lives of the people of Ghana</h2>
