...
const About = () => {
  return (
    ...
    <img
        src="founder.JPG"
        className="h-auto max-full rounded-lg shadow-none transition-shadow duration-300 ease-in-out hover:shadow-lg hover:shadow-black/30"
        alt="" />
        <em></em>
    </div>
